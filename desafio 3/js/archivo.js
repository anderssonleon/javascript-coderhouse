    ...
    if (productosAgregados == 1) {
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                ...
                productosAlCarrito = productosAlCarrito * ahesivo.precio;
                agregarCantidad = false;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * paleta.precio;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * delineador.precio;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * labialExfoliante.precio;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * paletaIluminadora.precio;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * setAriel.precio;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * mascaraDeColageno.precio ;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * mascaraDapop.precio;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * comboPaletas.precio;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * mascaraDescongestiva.precio;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * aguaMiselar.precio;
        ...
        if (agregarCantidad == true ) {
            ...
            if (productosAlCarrito <= 10) {
                totalDeProductos = productosAlCarrito + totalDeProductos;
                productosAlCarrito = productosAlCarrito * delineadorLiquido.precio;
            } else if(productosAlCarrito > 10){
                alert(`maximo de 10 productos`);
            }        
        }
...
class CalculadoraPrecioFinal{
    ...
    impuestoAgregado() {
        const precioDescuento = this.valorConDescuento()
        const impuesto = precioDescuento * (12/100)
...
document.write(`valor total con impuesto: ${calculadora.impuestoAgregado()}`);
